      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-cream-300 mb-8 text-base md:text-lg leading-relaxed max-w-md text-body">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className={`p-3 md:p-4 rounded-2xl bg-coffee-800 hover:bg-coffee-700 transition-all duration-500 ${social.color} group shadow-lg hover:shadow-xl`}
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-neutral-300 text-sm md:text-base">{cafe.address?.street || "20 Kemble Gallery"}</p>
                  <p className="text-neutral-300 text-sm md:text-base">{cafe.address?.city || "Leicester"} {cafe.address?.postcode || "LE1 3YT"}</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <span className="text-neutral-300 group-hover:text-white transition-colors duration-300 text-sm md:text-base">{cafe.contact?.phone || "0116 123 4567"}</span>
              </motion.a>
              ...
              >
                ...
                <span className="text-neutral-300 group-hover:text-white transition-colors duration-300 text-sm md:text-base">{cafe.contact?.email || "hello@thesipincafe.co.uk"}</span>
              </motion.a>
            </div>
          </motion.div>
              ...
              {cafe.openingHours && cafe.openingHours.length > 0 ? (
                cafe.openingHours.map((hours, index) => (
                  <motion.div 
                    ...
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <span className="text-neutral-300 text-sm md:text-base capitalize">{hours.day}</span>
                ...
                <>
                  <motion.div 
                    ...
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <span className="text-neutral-300 text-sm md:text-base">Monday - Friday</span>
                  ...
                  <motion.div 
                    ...
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <span className="text-neutral-300 text-sm md:text-base">Saturday</span>
                  ...
                  <motion.div 
                    ...
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <span className="text-neutral-300 text-sm md:text-base">Sunday</span>
                    <span className="text-primary font-semibold text-sm md:text-base">8:00 AM - 7:00 PM</span>
                  </motion.div>
                </>
              )}
